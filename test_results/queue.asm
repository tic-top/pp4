  ...
  _L2:
	...
	# _tmp62 = _tmp61 - _tmp60
	  lw $t0, -48($fp)	# fill _tmp61 to $t0 from $fp-48
	  lw $t1, -44($fp)	# fill _tmp60 to $t1 from $fp-44
	  sub $t2, $t0, $t1	
  ...
  _L4:
	...
	# _tmp71 = _tmp70 - _tmp69
	  lw $t0, -84($fp)	# fill _tmp70 to $t0 from $fp-84
	  lw $t1, -80($fp)	# fill _tmp69 to $t1 from $fp-80
	  sub $t2, $t0, $t1	
  ...
  _L6:
	...
	# _tmp83 = _tmp82 - _tmp81
	  lw $t0, -132($fp)	# fill _tmp82 to $t0 from $fp-132
	  lw $t1, -128($fp)	# fill _tmp81 to $t1 from $fp-128
	  sub $t2, $t0, $t1	
  ...
  _L8:
	...
	# _tmp92 = _tmp91 - _tmp90
	  lw $t0, -168($fp)	# fill _tmp91 to $t0 from $fp-168
	  lw $t1, -164($fp)	# fill _tmp90 to $t1 from $fp-164
	  sub $t2, $t0, $t1	
