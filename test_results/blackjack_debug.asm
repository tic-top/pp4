  ...
  _House.TakeAllBets:
	...
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# _tmp512 = "debug players null? "
	  .data			# create string constant marked with label
	  _string54: .asciiz "debug players null? "
	  .text
	  la $t2, _string54	# load label
	  sw $t2, -16($fp)	# spill _tmp512 from $t2 to $fp-16
	# PushParam _tmp512
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -16($fp)	# fill _tmp512 to $t0 from $fp-16
	  sw $t0, 4($sp)	# copy param value to stack
	# LCall _PrintString
	  jal _PrintString   	# jump to function
	# PopParams 4
	...
	# i = _tmp517
	  lw $t2, -36($fp)	# fill _tmp517 to $t2 from $fp-36
	  sw $t2, -8($fp)	# spill i from $t2 to $fp-8
  _L115:
	# _tmp518 = *(this + 4)
	  lw $t0, 4($fp)	# fill this to $t0 from $fp+4
	...
	# _tmp519 = *(_tmp518)
	  lw $t0, -40($fp)	# fill _tmp518 to $t0 from $fp-40
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -44($fp)	# spill _tmp519 from $t2 to $fp-44
	# _tmp520 = i < _tmp519
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -44($fp)	# fill _tmp519 to $t1 from $fp-44
	  slt $t2, $t0, $t1	
	  sw $t2, -48($fp)	# spill _tmp520 from $t2 to $fp-48
	# IfZ _tmp520 Goto _L116
	  lw $t0, -48($fp)	# fill _tmp520 to $t0 from $fp-48
	  beqz $t0, _L116	# branch if _tmp520 is zero 
	# _tmp521 = *(this + 4)
	  lw $t0, 4($fp)	# fill this to $t0 from $fp+4
	  lw $t2, 4($t0) 	# load with offset
  ...
  _L117:
	...
	# IfZ _tmp525 Goto _L118
	  lw $t0, -68($fp)	# fill _tmp525 to $t0 from $fp-68
	  beqz $t0, _L118	# branch if _tmp525 is zero 
	# PushParam _tmp522
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -56($fp)	# fill _tmp522 to $t0 from $fp-56
	  sw $t0, 4($sp)	# copy param value to stack
  ...
  _L118:
	...
	# IfZ _tmp527 Goto _L120
	  lw $t0, -76($fp)	# fill _tmp527 to $t0 from $fp-76
	  beqz $t0, _L120	# branch if _tmp527 is zero 
	# Goto _L119
  ...
  _L119:
	...
	# _tmp529 = i + _tmp528
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -80($fp)	# fill _tmp528 to $t1 from $fp-80
	  add $t2, $t0, $t1	
	  sw $t2, -84($fp)	# spill _tmp529 from $t2 to $fp-84
	# _tmp530 = 4
	  li $t2, 4		# load constant value 4 into $t2
	  sw $t2, -88($fp)	# spill _tmp530 from $t2 to $fp-88
	# _tmp531 = _tmp529 * _tmp530
	  lw $t0, -84($fp)	# fill _tmp529 to $t0 from $fp-84
	  lw $t1, -88($fp)	# fill _tmp530 to $t1 from $fp-88
	  mul $t2, $t0, $t1	
	  sw $t2, -92($fp)	# spill _tmp531 from $t2 to $fp-92
	# _tmp532 = _tmp521 + _tmp531
	  lw $t0, -52($fp)	# fill _tmp521 to $t0 from $fp-52
	  lw $t1, -92($fp)	# fill _tmp531 to $t1 from $fp-92
	  add $t2, $t0, $t1	
	...
	# _tmp535 = *(_tmp534 + 16)
	  lw $t0, -104($fp)	# fill _tmp534 to $t0 from $fp-104
	  lw $t2, 16($t0) 	# load with offset
	...
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# IfZ _tmp536 Goto _L121
	  lw $t0, -112($fp)	# fill _tmp536 to $t0 from $fp-112
	  beqz $t0, _L121	# branch if _tmp536 is zero 
	# _tmp537 = *(this + 4)
	  lw $t0, 4($fp)	# fill this to $t0 from $fp+4
	  lw $t2, 4($t0) 	# load with offset
	  sw $t2, -116($fp)	# spill _tmp537 from $t2 to $fp-116
	# _tmp538 = "Decaf runtime error: Array subscript out of bound..."
	  .data			# create string constant marked with label
  ...
  _L123:
	...
	# IfZ _tmp541 Goto _L124
	  lw $t0, -132($fp)	# fill _tmp541 to $t0 from $fp-132
	  beqz $t0, _L124	# branch if _tmp541 is zero 
	# PushParam _tmp538
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -120($fp)	# fill _tmp538 to $t0 from $fp-120
	  sw $t0, 4($sp)	# copy param value to stack
  ...
  _L124:
	...
	# IfZ _tmp543 Goto _L126
	  lw $t0, -140($fp)	# fill _tmp543 to $t0 from $fp-140
	  beqz $t0, _L126	# branch if _tmp543 is zero 
	# Goto _L125
  ...
  _L125:
	...
	# _tmp545 = i + _tmp544
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -144($fp)	# fill _tmp544 to $t1 from $fp-144
	  add $t2, $t0, $t1	
	  sw $t2, -148($fp)	# spill _tmp545 from $t2 to $fp-148
	# _tmp546 = 4
	  li $t2, 4		# load constant value 4 into $t2
	  sw $t2, -152($fp)	# spill _tmp546 from $t2 to $fp-152
	# _tmp547 = _tmp545 * _tmp546
	  lw $t0, -148($fp)	# fill _tmp545 to $t0 from $fp-148
	  lw $t1, -152($fp)	# fill _tmp546 to $t1 from $fp-152
	  mul $t2, $t0, $t1	
	  sw $t2, -156($fp)	# spill _tmp547 from $t2 to $fp-156
	# _tmp548 = _tmp537 + _tmp547
	  lw $t0, -116($fp)	# fill _tmp537 to $t0 from $fp-116
	  lw $t1, -156($fp)	# fill _tmp547 to $t1 from $fp-156
	  add $t2, $t0, $t1	
	  sw $t2, -160($fp)	# spill _tmp548 from $t2 to $fp-160
	# _tmp549 = *(_tmp548)
	  lw $t0, -160($fp)	# fill _tmp548 to $t0 from $fp-160
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -164($fp)	# spill _tmp549 from $t2 to $fp-164
	# PushParam _tmp549
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -164($fp)	# fill _tmp549 to $t0 from $fp-164
	  sw $t0, 4($sp)	# copy param value to stack
	# _tmp550 = *(_tmp549)
	  lw $t0, -164($fp)	# fill _tmp549 to $t0 from $fp-164
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -168($fp)	# spill _tmp550 from $t2 to $fp-168
	# _tmp551 = *(_tmp550 + 24)
	  lw $t0, -168($fp)	# fill _tmp550 to $t0 from $fp-168
	  lw $t2, 24($t0) 	# load with offset
	  sw $t2, -172($fp)	# spill _tmp551 from $t2 to $fp-172
	# ACall _tmp551
	  lw $t0, -172($fp)	# fill _tmp551 to $t0 from $fp-172
	  jalr $t0            	# jump to function
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# Goto _L122
  ...
  _L122:
	# _tmp552 = 1
	  li $t2, 1		# load constant value 1 into $t2
	  sw $t2, -176($fp)	# spill _tmp552 from $t2 to $fp-176
	# _tmp553 = i + _tmp552
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -176($fp)	# fill _tmp552 to $t1 from $fp-176
	  add $t2, $t0, $t1	
	  sw $t2, -180($fp)	# spill _tmp553 from $t2 to $fp-180
	# i = _tmp553
	  lw $t2, -180($fp)	# fill _tmp553 to $t2 from $fp-180
	  sw $t2, -8($fp)	# spill i from $t2 to $fp-8
	# Goto _L115
  ...
  _House.TakeAllTurns:
	...
	# _tmp554 = 0
	  li $t2, 0		# load constant value 0 into $t2
	  sw $t2, -12($fp)	# spill _tmp554 from $t2 to $fp-12
	# i = _tmp554
	  lw $t2, -12($fp)	# fill _tmp554 to $t2 from $fp-12
	  sw $t2, -8($fp)	# spill i from $t2 to $fp-8
  _L127:
	# _tmp555 = *(this + 4)
	  lw $t0, 4($fp)	# fill this to $t0 from $fp+4
	  lw $t2, 4($t0) 	# load with offset
	  sw $t2, -16($fp)	# spill _tmp555 from $t2 to $fp-16
	# _tmp556 = *(_tmp555)
	  lw $t0, -16($fp)	# fill _tmp555 to $t0 from $fp-16
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -20($fp)	# spill _tmp556 from $t2 to $fp-20
	# _tmp557 = i < _tmp556
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -20($fp)	# fill _tmp556 to $t1 from $fp-20
	  slt $t2, $t0, $t1	
	  sw $t2, -24($fp)	# spill _tmp557 from $t2 to $fp-24
	# IfZ _tmp557 Goto _L128
	  lw $t0, -24($fp)	# fill _tmp557 to $t0 from $fp-24
	  beqz $t0, _L128	# branch if _tmp557 is zero 
	# _tmp558 = *(this + 4)
	  lw $t0, 4($fp)	# fill this to $t0 from $fp+4
	  lw $t2, 4($t0) 	# load with offset
	  sw $t2, -28($fp)	# spill _tmp558 from $t2 to $fp-28
	# _tmp559 = "Decaf runtime error: Array subscript out of bound..."
	  ...
	  sw $t2, -32($fp)	# spill _tmp559 from $t2 to $fp-32
	# _tmp560 = 0
	  li $t2, 0		# load constant value 0 into $t2
	  sw $t2, -36($fp)	# spill _tmp560 from $t2 to $fp-36
	# _tmp561 = _tmp558 == _tmp560
	  lw $t0, -28($fp)	# fill _tmp558 to $t0 from $fp-28
	  lw $t1, -36($fp)	# fill _tmp560 to $t1 from $fp-36
	  seq $t2, $t0, $t1	
	  sw $t2, -40($fp)	# spill _tmp561 from $t2 to $fp-40
	# IfZ _tmp561 Goto _L129
	  lw $t0, -40($fp)	# fill _tmp561 to $t0 from $fp-40
	  beqz $t0, _L129	# branch if _tmp561 is zero 
	# PushParam _tmp559
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -32($fp)	# fill _tmp559 to $t0 from $fp-32
	  sw $t0, 4($sp)	# copy param value to stack
	# LCall _PrintString
	  jal _PrintString   	# jump to function
	# PopParams 4
  ...
  _L129:
	# _tmp562 = i < _tmp560
	  ...
	  lw $t1, -36($fp)	# fill _tmp560 to $t1 from $fp-36
	  slt $t2, $t0, $t1	
	  sw $t2, -44($fp)	# spill _tmp562 from $t2 to $fp-44
	# IfZ _tmp562 Goto _L130
	  lw $t0, -44($fp)	# fill _tmp562 to $t0 from $fp-44
	  beqz $t0, _L130	# branch if _tmp562 is zero 
	# PushParam _tmp559
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -32($fp)	# fill _tmp559 to $t0 from $fp-32
	  sw $t0, 4($sp)	# copy param value to stack
  ...
  _L130:
	# _tmp563 = *(_tmp558)
	  lw $t0, -28($fp)	# fill _tmp558 to $t0 from $fp-28
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -48($fp)	# spill _tmp563 from $t2 to $fp-48
	# _tmp564 = i < _tmp563
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -48($fp)	# fill _tmp563 to $t1 from $fp-48
	  slt $t2, $t0, $t1	
	  sw $t2, -52($fp)	# spill _tmp564 from $t2 to $fp-52
	# IfZ _tmp564 Goto _L132
	  lw $t0, -52($fp)	# fill _tmp564 to $t0 from $fp-52
	  beqz $t0, _L132	# branch if _tmp564 is zero 
	# Goto _L131
  ...
  _L131:
	# _tmp565 = 1
	  li $t2, 1		# load constant value 1 into $t2
	  sw $t2, -56($fp)	# spill _tmp565 from $t2 to $fp-56
	# _tmp566 = i + _tmp565
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -56($fp)	# fill _tmp565 to $t1 from $fp-56
	  add $t2, $t0, $t1	
	  sw $t2, -60($fp)	# spill _tmp566 from $t2 to $fp-60
	# _tmp567 = 4
	  li $t2, 4		# load constant value 4 into $t2
	  sw $t2, -64($fp)	# spill _tmp567 from $t2 to $fp-64
	# _tmp568 = _tmp566 * _tmp567
	  lw $t0, -60($fp)	# fill _tmp566 to $t0 from $fp-60
	  lw $t1, -64($fp)	# fill _tmp567 to $t1 from $fp-64
	  mul $t2, $t0, $t1	
	  sw $t2, -68($fp)	# spill _tmp568 from $t2 to $fp-68
	# _tmp569 = _tmp558 + _tmp568
	  lw $t0, -28($fp)	# fill _tmp558 to $t0 from $fp-28
	  lw $t1, -68($fp)	# fill _tmp568 to $t1 from $fp-68
	  add $t2, $t0, $t1	
	  sw $t2, -72($fp)	# spill _tmp569 from $t2 to $fp-72
	# _tmp570 = *(_tmp569)
	  lw $t0, -72($fp)	# fill _tmp569 to $t0 from $fp-72
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -76($fp)	# spill _tmp570 from $t2 to $fp-76
	# PushParam _tmp570
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -76($fp)	# fill _tmp570 to $t0 from $fp-76
	  sw $t0, 4($sp)	# copy param value to stack
	# _tmp571 = *(_tmp570)
	  lw $t0, -76($fp)	# fill _tmp570 to $t0 from $fp-76
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -80($fp)	# spill _tmp571 from $t2 to $fp-80
	# _tmp572 = *(_tmp571 + 16)
	  lw $t0, -80($fp)	# fill _tmp571 to $t0 from $fp-80
	  lw $t2, 16($t0) 	# load with offset
	  sw $t2, -84($fp)	# spill _tmp572 from $t2 to $fp-84
	# _tmp573 = ACall _tmp572
	  lw $t0, -84($fp)	# fill _tmp572 to $t0 from $fp-84
	  jalr $t0            	# jump to function
	  move $t2, $v0		# copy function return value from $v0
	  sw $t2, -88($fp)	# spill _tmp573 from $t2 to $fp-88
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# IfZ _tmp573 Goto _L133
	  lw $t0, -88($fp)	# fill _tmp573 to $t0 from $fp-88
	  beqz $t0, _L133	# branch if _tmp573 is zero 
	# _tmp574 = *(this + 12)
	  lw $t0, 4($fp)	# fill this to $t0 from $fp+4
	  lw $t2, 12($t0) 	# load with offset
	  sw $t2, -92($fp)	# spill _tmp574 from $t2 to $fp-92
	# PushParam _tmp574
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -92($fp)	# fill _tmp574 to $t0 from $fp-92
	  sw $t0, 4($sp)	# copy param value to stack
	# _tmp575 = *(this + 4)
	  lw $t0, 4($fp)	# fill this to $t0 from $fp+4
	  lw $t2, 4($t0) 	# load with offset
	  sw $t2, -96($fp)	# spill _tmp575 from $t2 to $fp-96
	# _tmp576 = "Decaf runtime error: Array subscript out of bound..."
	  ...
	  sw $t2, -100($fp)	# spill _tmp576 from $t2 to $fp-100
	# _tmp577 = 0
	  li $t2, 0		# load constant value 0 into $t2
	  sw $t2, -104($fp)	# spill _tmp577 from $t2 to $fp-104
	# _tmp578 = _tmp575 == _tmp577
	  lw $t0, -96($fp)	# fill _tmp575 to $t0 from $fp-96
	  lw $t1, -104($fp)	# fill _tmp577 to $t1 from $fp-104
	  seq $t2, $t0, $t1	
	  sw $t2, -108($fp)	# spill _tmp578 from $t2 to $fp-108
	# IfZ _tmp578 Goto _L135
	  lw $t0, -108($fp)	# fill _tmp578 to $t0 from $fp-108
	  beqz $t0, _L135	# branch if _tmp578 is zero 
	# PushParam _tmp576
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -100($fp)	# fill _tmp576 to $t0 from $fp-100
	  sw $t0, 4($sp)	# copy param value to stack
	# LCall _PrintString
	  jal _PrintString   	# jump to function
	# PopParams 4
  ...
  _L135:
	# _tmp579 = i < _tmp577
	  ...
	  lw $t1, -104($fp)	# fill _tmp577 to $t1 from $fp-104
	  slt $t2, $t0, $t1	
	  sw $t2, -112($fp)	# spill _tmp579 from $t2 to $fp-112
	# IfZ _tmp579 Goto _L136
	  lw $t0, -112($fp)	# fill _tmp579 to $t0 from $fp-112
	  beqz $t0, _L136	# branch if _tmp579 is zero 
	# PushParam _tmp576
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -100($fp)	# fill _tmp576 to $t0 from $fp-100
	  sw $t0, 4($sp)	# copy param value to stack
  ...
  _L136:
	# _tmp580 = *(_tmp575)
	  lw $t0, -96($fp)	# fill _tmp575 to $t0 from $fp-96
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -116($fp)	# spill _tmp580 from $t2 to $fp-116
	# _tmp581 = i < _tmp580
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -116($fp)	# fill _tmp580 to $t1 from $fp-116
	  slt $t2, $t0, $t1	
	  sw $t2, -120($fp)	# spill _tmp581 from $t2 to $fp-120
	# IfZ _tmp581 Goto _L138
	  lw $t0, -120($fp)	# fill _tmp581 to $t0 from $fp-120
	  beqz $t0, _L138	# branch if _tmp581 is zero 
	# Goto _L137
  ...
  _L137:
	# _tmp582 = 1
	  li $t2, 1		# load constant value 1 into $t2
	  sw $t2, -124($fp)	# spill _tmp582 from $t2 to $fp-124
	# _tmp583 = i + _tmp582
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -124($fp)	# fill _tmp582 to $t1 from $fp-124
	  add $t2, $t0, $t1	
	  sw $t2, -128($fp)	# spill _tmp583 from $t2 to $fp-128
	# _tmp584 = 4
	  li $t2, 4		# load constant value 4 into $t2
	  sw $t2, -132($fp)	# spill _tmp584 from $t2 to $fp-132
	# _tmp585 = _tmp583 * _tmp584
	  lw $t0, -128($fp)	# fill _tmp583 to $t0 from $fp-128
	  lw $t1, -132($fp)	# fill _tmp584 to $t1 from $fp-132
	  mul $t2, $t0, $t1	
	  sw $t2, -136($fp)	# spill _tmp585 from $t2 to $fp-136
	# _tmp586 = _tmp575 + _tmp585
	  lw $t0, -96($fp)	# fill _tmp575 to $t0 from $fp-96
	  lw $t1, -136($fp)	# fill _tmp585 to $t1 from $fp-136
	  add $t2, $t0, $t1	
	  sw $t2, -140($fp)	# spill _tmp586 from $t2 to $fp-140
	# _tmp587 = *(_tmp586)
	  lw $t0, -140($fp)	# fill _tmp586 to $t0 from $fp-140
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -144($fp)	# spill _tmp587 from $t2 to $fp-144
	# PushParam _tmp587
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -144($fp)	# fill _tmp587 to $t0 from $fp-144
	  sw $t0, 4($sp)	# copy param value to stack
	# _tmp588 = *(_tmp587)
	  lw $t0, -144($fp)	# fill _tmp587 to $t0 from $fp-144
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -148($fp)	# spill _tmp588 from $t2 to $fp-148
	# _tmp589 = *(_tmp588 + 12)
	  lw $t0, -148($fp)	# fill _tmp588 to $t0 from $fp-148
	  lw $t2, 12($t0) 	# load with offset
	  sw $t2, -152($fp)	# spill _tmp589 from $t2 to $fp-152
	# ACall _tmp589
	  lw $t0, -152($fp)	# fill _tmp589 to $t0 from $fp-152
	  jalr $t0            	# jump to function
	# PopParams 8
	  add $sp, $sp, 8	# pop params off stack
	# Goto _L134
  ...
  _L134:
	# _tmp590 = 1
	  li $t2, 1		# load constant value 1 into $t2
	  sw $t2, -156($fp)	# spill _tmp590 from $t2 to $fp-156
	# _tmp591 = i + _tmp590
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -156($fp)	# fill _tmp590 to $t1 from $fp-156
	  add $t2, $t0, $t1	
	  sw $t2, -160($fp)	# spill _tmp591 from $t2 to $fp-160
	# i = _tmp591
	  lw $t2, -160($fp)	# fill _tmp591 to $t2 from $fp-160
	  sw $t2, -8($fp)	# spill i from $t2 to $fp-8
	# Goto _L127
  ...
  _House.ResolveAllPlayers:
	...
	# _tmp592 = "\nTime to resolve bets.\n"
	  ...
	  sw $t2, -12($fp)	# spill _tmp592 from $t2 to $fp-12
	# PushParam _tmp592
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -12($fp)	# fill _tmp592 to $t0 from $fp-12
	  sw $t0, 4($sp)	# copy param value to stack
	# LCall _PrintString
	  jal _PrintString   	# jump to function
	# PopParams 4
	...
	# _tmp593 = 0
	  li $t2, 0		# load constant value 0 into $t2
	  sw $t2, -16($fp)	# spill _tmp593 from $t2 to $fp-16
	# i = _tmp593
	  lw $t2, -16($fp)	# fill _tmp593 to $t2 from $fp-16
	  sw $t2, -8($fp)	# spill i from $t2 to $fp-8
  _L139:
	# _tmp594 = *(this + 4)
	  lw $t0, 4($fp)	# fill this to $t0 from $fp+4
	  lw $t2, 4($t0) 	# load with offset
	  sw $t2, -20($fp)	# spill _tmp594 from $t2 to $fp-20
	# _tmp595 = *(_tmp594)
	  lw $t0, -20($fp)	# fill _tmp594 to $t0 from $fp-20
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -24($fp)	# spill _tmp595 from $t2 to $fp-24
	# _tmp596 = i < _tmp595
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -24($fp)	# fill _tmp595 to $t1 from $fp-24
	  slt $t2, $t0, $t1	
	  sw $t2, -28($fp)	# spill _tmp596 from $t2 to $fp-28
	# IfZ _tmp596 Goto _L140
	  lw $t0, -28($fp)	# fill _tmp596 to $t0 from $fp-28
	  beqz $t0, _L140	# branch if _tmp596 is zero 
	# _tmp597 = *(this + 4)
	  lw $t0, 4($fp)	# fill this to $t0 from $fp+4
	  lw $t2, 4($t0) 	# load with offset
	  sw $t2, -32($fp)	# spill _tmp597 from $t2 to $fp-32
	# _tmp598 = "Decaf runtime error: Array subscript out of bound..."
	  .data			# create string constant marked with label
	  _string61: .asciiz "Decaf runtime error: Array subscript out of bounds\n"
	  .text
	  la $t2, _string61	# load label
	  sw $t2, -36($fp)	# spill _tmp598 from $t2 to $fp-36
	# _tmp599 = 0
	  li $t2, 0		# load constant value 0 into $t2
	  sw $t2, -40($fp)	# spill _tmp599 from $t2 to $fp-40
	# _tmp600 = _tmp597 == _tmp599
	  lw $t0, -32($fp)	# fill _tmp597 to $t0 from $fp-32
	  lw $t1, -40($fp)	# fill _tmp599 to $t1 from $fp-40
	  seq $t2, $t0, $t1	
	  sw $t2, -44($fp)	# spill _tmp600 from $t2 to $fp-44
	# IfZ _tmp600 Goto _L141
	  lw $t0, -44($fp)	# fill _tmp600 to $t0 from $fp-44
	  beqz $t0, _L141	# branch if _tmp600 is zero 
	# PushParam _tmp598
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -36($fp)	# fill _tmp598 to $t0 from $fp-36
	  sw $t0, 4($sp)	# copy param value to stack
	# LCall _PrintString
	  jal _PrintString   	# jump to function
	# PopParams 4
  ...
  _L141:
	# _tmp601 = i < _tmp599
	  ...
	  lw $t1, -40($fp)	# fill _tmp599 to $t1 from $fp-40
	  slt $t2, $t0, $t1	
	  sw $t2, -48($fp)	# spill _tmp601 from $t2 to $fp-48
	# IfZ _tmp601 Goto _L142
	  lw $t0, -48($fp)	# fill _tmp601 to $t0 from $fp-48
	  beqz $t0, _L142	# branch if _tmp601 is zero 
	# PushParam _tmp598
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -36($fp)	# fill _tmp598 to $t0 from $fp-36
	  sw $t0, 4($sp)	# copy param value to stack
  ...
  _L142:
	# _tmp602 = *(_tmp597)
	  lw $t0, -32($fp)	# fill _tmp597 to $t0 from $fp-32
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -52($fp)	# spill _tmp602 from $t2 to $fp-52
	# _tmp603 = i < _tmp602
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -52($fp)	# fill _tmp602 to $t1 from $fp-52
	  slt $t2, $t0, $t1	
	  sw $t2, -56($fp)	# spill _tmp603 from $t2 to $fp-56
	# IfZ _tmp603 Goto _L144
	  lw $t0, -56($fp)	# fill _tmp603 to $t0 from $fp-56
	  beqz $t0, _L144	# branch if _tmp603 is zero 
	# Goto _L143
  ...
  _L143:
	# _tmp604 = 1
	  li $t2, 1		# load constant value 1 into $t2
	  sw $t2, -60($fp)	# spill _tmp604 from $t2 to $fp-60
	# _tmp605 = i + _tmp604
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -60($fp)	# fill _tmp604 to $t1 from $fp-60
	  add $t2, $t0, $t1	
	  sw $t2, -64($fp)	# spill _tmp605 from $t2 to $fp-64
	# _tmp606 = 4
	  li $t2, 4		# load constant value 4 into $t2
	  sw $t2, -68($fp)	# spill _tmp606 from $t2 to $fp-68
	# _tmp607 = _tmp605 * _tmp606
	  lw $t0, -64($fp)	# fill _tmp605 to $t0 from $fp-64
	  lw $t1, -68($fp)	# fill _tmp606 to $t1 from $fp-68
	  mul $t2, $t0, $t1	
	  sw $t2, -72($fp)	# spill _tmp607 from $t2 to $fp-72
	# _tmp608 = _tmp597 + _tmp607
	  lw $t0, -32($fp)	# fill _tmp597 to $t0 from $fp-32
	  lw $t1, -72($fp)	# fill _tmp607 to $t1 from $fp-72
	  add $t2, $t0, $t1	
	  sw $t2, -76($fp)	# spill _tmp608 from $t2 to $fp-76
	# _tmp609 = *(_tmp608)
	  lw $t0, -76($fp)	# fill _tmp608 to $t0 from $fp-76
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -80($fp)	# spill _tmp609 from $t2 to $fp-80
	# PushParam _tmp609
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -80($fp)	# fill _tmp609 to $t0 from $fp-80
	  sw $t0, 4($sp)	# copy param value to stack
	# _tmp610 = *(_tmp609)
	  lw $t0, -80($fp)	# fill _tmp609 to $t0 from $fp-80
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -84($fp)	# spill _tmp610 from $t2 to $fp-84
	# _tmp611 = *(_tmp610 + 16)
	  lw $t0, -84($fp)	# fill _tmp610 to $t0 from $fp-84
	  lw $t2, 16($t0) 	# load with offset
	  sw $t2, -88($fp)	# spill _tmp611 from $t2 to $fp-88
	# _tmp612 = ACall _tmp611
	  lw $t0, -88($fp)	# fill _tmp611 to $t0 from $fp-88
	  jalr $t0            	# jump to function
	  move $t2, $v0		# copy function return value from $v0
	  sw $t2, -92($fp)	# spill _tmp612 from $t2 to $fp-92
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# IfZ _tmp612 Goto _L145
	  lw $t0, -92($fp)	# fill _tmp612 to $t0 from $fp-92
	  beqz $t0, _L145	# branch if _tmp612 is zero 
	# _tmp613 = *(this + 8)
	  lw $t0, 4($fp)	# fill this to $t0 from $fp+4
	  lw $t2, 8($t0) 	# load with offset
	  sw $t2, -96($fp)	# spill _tmp613 from $t2 to $fp-96
	# PushParam _tmp613
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -96($fp)	# fill _tmp613 to $t0 from $fp-96
	  sw $t0, 4($sp)	# copy param value to stack
	# _tmp614 = *(_tmp613)
	  lw $t0, -96($fp)	# fill _tmp613 to $t0 from $fp-96
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -100($fp)	# spill _tmp614 from $t2 to $fp-100
	# _tmp615 = *(_tmp614 + 28)
	  lw $t0, -100($fp)	# fill _tmp614 to $t0 from $fp-100
	  lw $t2, 28($t0) 	# load with offset
	  sw $t2, -104($fp)	# spill _tmp615 from $t2 to $fp-104
	# _tmp616 = ACall _tmp615
	  lw $t0, -104($fp)	# fill _tmp615 to $t0 from $fp-104
	  jalr $t0            	# jump to function
	  move $t2, $v0		# copy function return value from $v0
	  sw $t2, -108($fp)	# spill _tmp616 from $t2 to $fp-108
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# PushParam _tmp616
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -108($fp)	# fill _tmp616 to $t0 from $fp-108
	  sw $t0, 4($sp)	# copy param value to stack
	# _tmp617 = *(this + 4)
	  lw $t0, 4($fp)	# fill this to $t0 from $fp+4
	  lw $t2, 4($t0) 	# load with offset
	  sw $t2, -112($fp)	# spill _tmp617 from $t2 to $fp-112
	# _tmp618 = "Decaf runtime error: Array subscript out of bound..."
	  .data			# create string constant marked with label
	  _string62: .asciiz "Decaf runtime error: Array subscript out of bounds\n"
	  .text
	  la $t2, _string62	# load label
	  sw $t2, -116($fp)	# spill _tmp618 from $t2 to $fp-116
	# _tmp619 = 0
	  li $t2, 0		# load constant value 0 into $t2
	  sw $t2, -120($fp)	# spill _tmp619 from $t2 to $fp-120
	# _tmp620 = _tmp617 == _tmp619
	  lw $t0, -112($fp)	# fill _tmp617 to $t0 from $fp-112
	  lw $t1, -120($fp)	# fill _tmp619 to $t1 from $fp-120
	  seq $t2, $t0, $t1	
	  sw $t2, -124($fp)	# spill _tmp620 from $t2 to $fp-124
	# IfZ _tmp620 Goto _L147
	  lw $t0, -124($fp)	# fill _tmp620 to $t0 from $fp-124
	  beqz $t0, _L147	# branch if _tmp620 is zero 
	# PushParam _tmp618
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -116($fp)	# fill _tmp618 to $t0 from $fp-116
	  sw $t0, 4($sp)	# copy param value to stack
	# LCall _PrintString
	  jal _PrintString   	# jump to function
	# PopParams 4
  ...
  _L147:
	# _tmp621 = i < _tmp619
	  ...
	  lw $t1, -120($fp)	# fill _tmp619 to $t1 from $fp-120
	  slt $t2, $t0, $t1	
	  sw $t2, -128($fp)	# spill _tmp621 from $t2 to $fp-128
	# IfZ _tmp621 Goto _L148
	  lw $t0, -128($fp)	# fill _tmp621 to $t0 from $fp-128
	  beqz $t0, _L148	# branch if _tmp621 is zero 
	# PushParam _tmp618
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -116($fp)	# fill _tmp618 to $t0 from $fp-116
	  sw $t0, 4($sp)	# copy param value to stack
  ...
  _L148:
	# _tmp622 = *(_tmp617)
	  lw $t0, -112($fp)	# fill _tmp617 to $t0 from $fp-112
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -132($fp)	# spill _tmp622 from $t2 to $fp-132
	# _tmp623 = i < _tmp622
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -132($fp)	# fill _tmp622 to $t1 from $fp-132
	  slt $t2, $t0, $t1	
	  sw $t2, -136($fp)	# spill _tmp623 from $t2 to $fp-136
	# IfZ _tmp623 Goto _L150
	  lw $t0, -136($fp)	# fill _tmp623 to $t0 from $fp-136
	  beqz $t0, _L150	# branch if _tmp623 is zero 
	# Goto _L149
  ...
  _L149:
	# _tmp624 = 1
	  li $t2, 1		# load constant value 1 into $t2
	  sw $t2, -140($fp)	# spill _tmp624 from $t2 to $fp-140
	# _tmp625 = i + _tmp624
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -140($fp)	# fill _tmp624 to $t1 from $fp-140
	  add $t2, $t0, $t1	
	  sw $t2, -144($fp)	# spill _tmp625 from $t2 to $fp-144
	# _tmp626 = 4
	  li $t2, 4		# load constant value 4 into $t2
	  sw $t2, -148($fp)	# spill _tmp626 from $t2 to $fp-148
	# _tmp627 = _tmp625 * _tmp626
	  lw $t0, -144($fp)	# fill _tmp625 to $t0 from $fp-144
	  lw $t1, -148($fp)	# fill _tmp626 to $t1 from $fp-148
	  mul $t2, $t0, $t1	
	  sw $t2, -152($fp)	# spill _tmp627 from $t2 to $fp-152
	# _tmp628 = _tmp617 + _tmp627
	  lw $t0, -112($fp)	# fill _tmp617 to $t0 from $fp-112
	  lw $t1, -152($fp)	# fill _tmp627 to $t1 from $fp-152
	  add $t2, $t0, $t1	
	  sw $t2, -156($fp)	# spill _tmp628 from $t2 to $fp-156
	# _tmp629 = *(_tmp628)
	  lw $t0, -156($fp)	# fill _tmp628 to $t0 from $fp-156
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -160($fp)	# spill _tmp629 from $t2 to $fp-160
	# PushParam _tmp629
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -160($fp)	# fill _tmp629 to $t0 from $fp-160
	  sw $t0, 4($sp)	# copy param value to stack
	# _tmp630 = *(_tmp629)
	  lw $t0, -160($fp)	# fill _tmp629 to $t0 from $fp-160
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -164($fp)	# spill _tmp630 from $t2 to $fp-164
	# _tmp631 = *(_tmp630 + 32)
	  lw $t0, -164($fp)	# fill _tmp630 to $t0 from $fp-164
	  lw $t2, 32($t0) 	# load with offset
	  sw $t2, -168($fp)	# spill _tmp631 from $t2 to $fp-168
	# ACall _tmp631
	  lw $t0, -168($fp)	# fill _tmp631 to $t0 from $fp-168
	  jalr $t0            	# jump to function
	# PopParams 8
	  add $sp, $sp, 8	# pop params off stack
	# Goto _L146
  ...
  _L146:
	# _tmp632 = 1
	  li $t2, 1		# load constant value 1 into $t2
	  sw $t2, -172($fp)	# spill _tmp632 from $t2 to $fp-172
	# _tmp633 = i + _tmp632
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -172($fp)	# fill _tmp632 to $t1 from $fp-172
	  add $t2, $t0, $t1	
	  sw $t2, -176($fp)	# spill _tmp633 from $t2 to $fp-176
	# i = _tmp633
	  lw $t2, -176($fp)	# fill _tmp633 to $t2 from $fp-176
	  sw $t2, -8($fp)	# spill i from $t2 to $fp-8
	# Goto _L139
  ...
  _House.PrintAllMoney:
	...
	# _tmp634 = 0
	  li $t2, 0		# load constant value 0 into $t2
	  sw $t2, -12($fp)	# spill _tmp634 from $t2 to $fp-12
	# i = _tmp634
	  lw $t2, -12($fp)	# fill _tmp634 to $t2 from $fp-12
	  sw $t2, -8($fp)	# spill i from $t2 to $fp-8
  _L151:
	# _tmp635 = *(this + 4)
	  lw $t0, 4($fp)	# fill this to $t0 from $fp+4
	  lw $t2, 4($t0) 	# load with offset
	  sw $t2, -16($fp)	# spill _tmp635 from $t2 to $fp-16
	# _tmp636 = *(_tmp635)
	  lw $t0, -16($fp)	# fill _tmp635 to $t0 from $fp-16
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -20($fp)	# spill _tmp636 from $t2 to $fp-20
	# _tmp637 = i < _tmp636
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -20($fp)	# fill _tmp636 to $t1 from $fp-20
	  slt $t2, $t0, $t1	
	  sw $t2, -24($fp)	# spill _tmp637 from $t2 to $fp-24
	# IfZ _tmp637 Goto _L152
	  lw $t0, -24($fp)	# fill _tmp637 to $t0 from $fp-24
	  beqz $t0, _L152	# branch if _tmp637 is zero 
	# _tmp638 = *(this + 4)
	  lw $t0, 4($fp)	# fill this to $t0 from $fp+4
	  lw $t2, 4($t0) 	# load with offset
	  sw $t2, -28($fp)	# spill _tmp638 from $t2 to $fp-28
	# _tmp639 = "Decaf runtime error: Array subscript out of bound..."
	  ...
	  sw $t2, -32($fp)	# spill _tmp639 from $t2 to $fp-32
	# _tmp640 = 0
	  li $t2, 0		# load constant value 0 into $t2
	  sw $t2, -36($fp)	# spill _tmp640 from $t2 to $fp-36
	# _tmp641 = _tmp638 == _tmp640
	  lw $t0, -28($fp)	# fill _tmp638 to $t0 from $fp-28
	  lw $t1, -36($fp)	# fill _tmp640 to $t1 from $fp-36
	  seq $t2, $t0, $t1	
	  sw $t2, -40($fp)	# spill _tmp641 from $t2 to $fp-40
	# IfZ _tmp641 Goto _L153
	  lw $t0, -40($fp)	# fill _tmp641 to $t0 from $fp-40
	  beqz $t0, _L153	# branch if _tmp641 is zero 
	# PushParam _tmp639
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -32($fp)	# fill _tmp639 to $t0 from $fp-32
	  sw $t0, 4($sp)	# copy param value to stack
	# LCall _PrintString
	  jal _PrintString   	# jump to function
	# PopParams 4
  ...
  _L153:
	# _tmp642 = i < _tmp640
	  ...
	  lw $t1, -36($fp)	# fill _tmp640 to $t1 from $fp-36
	  slt $t2, $t0, $t1	
	  sw $t2, -44($fp)	# spill _tmp642 from $t2 to $fp-44
	# IfZ _tmp642 Goto _L154
	  lw $t0, -44($fp)	# fill _tmp642 to $t0 from $fp-44
	  beqz $t0, _L154	# branch if _tmp642 is zero 
	# PushParam _tmp639
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -32($fp)	# fill _tmp639 to $t0 from $fp-32
	  sw $t0, 4($sp)	# copy param value to stack
  ...
  _L154:
	# _tmp643 = *(_tmp638)
	  lw $t0, -28($fp)	# fill _tmp638 to $t0 from $fp-28
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -48($fp)	# spill _tmp643 from $t2 to $fp-48
	# _tmp644 = i < _tmp643
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -48($fp)	# fill _tmp643 to $t1 from $fp-48
	  slt $t2, $t0, $t1	
	  sw $t2, -52($fp)	# spill _tmp644 from $t2 to $fp-52
	# IfZ _tmp644 Goto _L156
	  lw $t0, -52($fp)	# fill _tmp644 to $t0 from $fp-52
	  beqz $t0, _L156	# branch if _tmp644 is zero 
	# Goto _L155
  ...
  _L155:
	# _tmp645 = 1
	  li $t2, 1		# load constant value 1 into $t2
	  sw $t2, -56($fp)	# spill _tmp645 from $t2 to $fp-56
	# _tmp646 = i + _tmp645
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -56($fp)	# fill _tmp645 to $t1 from $fp-56
	  add $t2, $t0, $t1	
	  sw $t2, -60($fp)	# spill _tmp646 from $t2 to $fp-60
	# _tmp647 = 4
	  li $t2, 4		# load constant value 4 into $t2
	  sw $t2, -64($fp)	# spill _tmp647 from $t2 to $fp-64
	# _tmp648 = _tmp646 * _tmp647
	  lw $t0, -60($fp)	# fill _tmp646 to $t0 from $fp-60
	  lw $t1, -64($fp)	# fill _tmp647 to $t1 from $fp-64
	  mul $t2, $t0, $t1	
	  sw $t2, -68($fp)	# spill _tmp648 from $t2 to $fp-68
	# _tmp649 = _tmp638 + _tmp648
	  lw $t0, -28($fp)	# fill _tmp638 to $t0 from $fp-28
	  lw $t1, -68($fp)	# fill _tmp648 to $t1 from $fp-68
	  add $t2, $t0, $t1	
	  sw $t2, -72($fp)	# spill _tmp649 from $t2 to $fp-72
	# _tmp650 = *(_tmp649)
	  lw $t0, -72($fp)	# fill _tmp649 to $t0 from $fp-72
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -76($fp)	# spill _tmp650 from $t2 to $fp-76
	# PushParam _tmp650
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -76($fp)	# fill _tmp650 to $t0 from $fp-76
	  sw $t0, 4($sp)	# copy param value to stack
	# _tmp651 = *(_tmp650)
	  lw $t0, -76($fp)	# fill _tmp650 to $t0 from $fp-76
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -80($fp)	# spill _tmp651 from $t2 to $fp-80
	# _tmp652 = *(_tmp651 + 20)
	  lw $t0, -80($fp)	# fill _tmp651 to $t0 from $fp-80
	  lw $t2, 20($t0) 	# load with offset
	  sw $t2, -84($fp)	# spill _tmp652 from $t2 to $fp-84
	# ACall _tmp652
	  lw $t0, -84($fp)	# fill _tmp652 to $t0 from $fp-84
	  jalr $t0            	# jump to function
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# _tmp653 = 1
	  li $t2, 1		# load constant value 1 into $t2
	  sw $t2, -88($fp)	# spill _tmp653 from $t2 to $fp-88
	# _tmp654 = i + _tmp653
	  lw $t0, -8($fp)	# fill i to $t0 from $fp-8
	  lw $t1, -88($fp)	# fill _tmp653 to $t1 from $fp-88
	  add $t2, $t0, $t1	
	  sw $t2, -92($fp)	# spill _tmp654 from $t2 to $fp-92
	# i = _tmp654
	  lw $t2, -92($fp)	# fill _tmp654 to $t2 from $fp-92
	  sw $t2, -8($fp)	# spill i from $t2 to $fp-8
	# Goto _L151
  ...
  _House.PlayOneGame:
	...
	# _tmp655 = *(this + 12)
	  lw $t0, 4($fp)	# fill this to $t0 from $fp+4
	  lw $t2, 12($t0) 	# load with offset
	  sw $t2, -8($fp)	# spill _tmp655 from $t2 to $fp-8
	# PushParam _tmp655
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -8($fp)	# fill _tmp655 to $t0 from $fp-8
	  sw $t0, 4($sp)	# copy param value to stack
	# _tmp656 = *(_tmp655)
	  lw $t0, -8($fp)	# fill _tmp655 to $t0 from $fp-8
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -12($fp)	# spill _tmp656 from $t2 to $fp-12
	# _tmp657 = *(_tmp656 + 12)
	  lw $t0, -12($fp)	# fill _tmp656 to $t0 from $fp-12
	  lw $t2, 12($t0) 	# load with offset
	  sw $t2, -16($fp)	# spill _tmp657 from $t2 to $fp-16
	# _tmp658 = ACall _tmp657
	  lw $t0, -16($fp)	# fill _tmp657 to $t0 from $fp-16
	  jalr $t0            	# jump to function
	  move $t2, $v0		# copy function return value from $v0
	...
	# _tmp660 = _tmp658 < _tmp659
	  lw $t0, -20($fp)	# fill _tmp658 to $t0 from $fp-20
	  lw $t1, -24($fp)	# fill _tmp659 to $t1 from $fp-24
	  slt $t2, $t0, $t1	
	  sw $t2, -28($fp)	# spill _tmp660 from $t2 to $fp-28
	# IfZ _tmp660 Goto _L157
	  lw $t0, -28($fp)	# fill _tmp660 to $t0 from $fp-28
	  beqz $t0, _L157	# branch if _tmp660 is zero 
	# _tmp661 = *(this + 12)
	  lw $t0, 4($fp)	# fill this to $t0 from $fp+4
	  lw $t2, 12($t0) 	# load with offset
	...
	# PushParam _tmp661
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -32($fp)	# fill _tmp661 to $t0 from $fp-32
	  sw $t0, 4($sp)	# copy param value to stack
	# _tmp662 = *(_tmp661)
	  lw $t0, -32($fp)	# fill _tmp661 to $t0 from $fp-32
	  lw $t2, 0($t0) 	# load with offset
  ...
  _L158:
	...
	# PushParam _tmp668
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -60($fp)	# fill _tmp668 to $t0 from $fp-60
	  sw $t0, 4($sp)	# copy param value to stack
	# _tmp669 = *(_tmp668)
	  lw $t0, -60($fp)	# fill _tmp668 to $t0 from $fp-60
	  lw $t2, 0($t0) 	# load with offset
	...
	# ACall _tmp670
	  lw $t0, -68($fp)	# fill _tmp670 to $t0 from $fp-68
	  jalr $t0            	# jump to function
	# PopParams 8
	  add $sp, $sp, 8	# pop params off stack
	# _tmp671 = *(this + 12)
	...
	# PushParam _tmp672
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -76($fp)	# fill _tmp672 to $t0 from $fp-76
	  sw $t0, 4($sp)	# copy param value to stack
	# _tmp673 = *(_tmp672)
	  lw $t0, -76($fp)	# fill _tmp672 to $t0 from $fp-76
	  lw $t2, 0($t0) 	# load with offset
	...
	# _tmp674 = *(_tmp673 + 4)
	  lw $t0, -80($fp)	# fill _tmp673 to $t0 from $fp-80
	  lw $t2, 4($t0) 	# load with offset
	...
	# ACall _tmp676
	  lw $t0, -92($fp)	# fill _tmp676 to $t0 from $fp-92
	  jalr $t0            	# jump to function
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# _tmp677 = *(this + 12)
	...
	# _tmp682 = *(_tmp681 + 16)
	  ...
	  lw $t2, 16($t0) 	# load with offset
	  sw $t2, -116($fp)	# spill _tmp682 from $t2 to $fp-116
	# ACall _tmp682
	  lw $t0, -116($fp)	# fill _tmp682 to $t0 from $fp-116
	  jalr $t0            	# jump to function
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# EndFunc
  ...
  _GetYesOrNo:
	...
	# _tmp683 = " (y/n) "
	  .data			# create string constant marked with label
	  _string65: .asciiz " (y/n) "
	  .text
	  la $t2, _string65	# load label
	  sw $t2, -12($fp)	# spill _tmp683 from $t2 to $fp-12
	# PushParam _tmp683
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -12($fp)	# fill _tmp683 to $t0 from $fp-12
	  sw $t0, 4($sp)	# copy param value to stack
	# LCall _PrintString
	  jal _PrintString   	# jump to function
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# _tmp684 = LCall _ReadLine
	  jal _ReadLine      	# jump to function
	  move $t2, $v0		# copy function return value from $v0
	  sw $t2, -16($fp)	# spill _tmp684 from $t2 to $fp-16
	# answer = _tmp684
	  lw $t2, -16($fp)	# fill _tmp684 to $t2 from $fp-16
	...
	# _tmp686 = "y"
	  ...
	  sw $t2, -24($fp)	# spill _tmp686 from $t2 to $fp-24
	# _tmp687 = answer == _tmp686
	  lw $t0, -8($fp)	# fill answer to $t0 from $fp-8
	  lw $t1, -24($fp)	# fill _tmp686 to $t1 from $fp-24
	  seq $t2, $t0, $t1	
	  sw $t2, -28($fp)	# spill _tmp687 from $t2 to $fp-28
	# IfZ _tmp687 Goto _L159
	  lw $t0, -28($fp)	# fill _tmp687 to $t0 from $fp-28
	  beqz $t0, _L159	# branch if _tmp687 is zero 
	# _tmp688 = 1
	  li $t2, 1		# load constant value 1 into $t2
	  sw $t2, -32($fp)	# spill _tmp688 from $t2 to $fp-32
	# _tmp685 = _tmp688
	  lw $t2, -32($fp)	# fill _tmp688 to $t2 from $fp-32
	  sw $t2, -20($fp)	# spill _tmp685 from $t2 to $fp-20
	# Goto _L160
  ...
  _L159:
	# _tmp689 = "Y"
	  ...
	  sw $t2, -36($fp)	# spill _tmp689 from $t2 to $fp-36
	# _tmp690 = answer == _tmp689
	  lw $t0, -8($fp)	# fill answer to $t0 from $fp-8
	  lw $t1, -36($fp)	# fill _tmp689 to $t1 from $fp-36
	  seq $t2, $t0, $t1	
	  sw $t2, -40($fp)	# spill _tmp690 from $t2 to $fp-40
	# _tmp685 = _tmp690
	  lw $t2, -40($fp)	# fill _tmp690 to $t2 from $fp-40
	  sw $t2, -20($fp)	# spill _tmp685 from $t2 to $fp-20
  _L160:
	# Return _tmp685
	  lw $t2, -20($fp)	# fill _tmp685 to $t2 from $fp-20
	  move $v0, $t2		# assign return value into $v0
	  move $sp, $fp		# pop callee frame off stack
	  lw $ra, -4($fp)	# restore saved ra
	  lw $fp, 0($fp)	# restore saved fp
  ...
  main:
	...
	# _tmp691 = 1
	  li $t2, 1		# load constant value 1 into $t2
	  sw $t2, -16($fp)	# spill _tmp691 from $t2 to $fp-16
	# keepPlaying = _tmp691
	  lw $t2, -16($fp)	# fill _tmp691 to $t2 from $fp-16
	  sw $t2, -8($fp)	# spill keepPlaying from $t2 to $fp-8
	# _tmp692 = 16
	  li $t2, 16		# load constant value 16 into $t2
	  sw $t2, -20($fp)	# spill _tmp692 from $t2 to $fp-20
	# PushParam _tmp692
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -20($fp)	# fill _tmp692 to $t0 from $fp-20
	  sw $t0, 4($sp)	# copy param value to stack
	# _tmp693 = LCall _Alloc
	  jal _Alloc         	# jump to function
	  move $t2, $v0		# copy function return value from $v0
	  sw $t2, -24($fp)	# spill _tmp693 from $t2 to $fp-24
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# _tmp694 = House
	  la $t2, House	# load label
	  sw $t2, -28($fp)	# spill _tmp694 from $t2 to $fp-28
	# *(_tmp693) = _tmp694
	  lw $t0, -28($fp)	# fill _tmp694 to $t0 from $fp-28
	  lw $t2, -24($fp)	# fill _tmp693 to $t2 from $fp-24
	  sw $t0, 0($t2) 	# store with offset
	# house = _tmp693
	  lw $t2, -24($fp)	# fill _tmp693 to $t2 from $fp-24
	...
	# _tmp695 = *(house)
	  lw $t0, -12($fp)	# fill house to $t0 from $fp-12
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -32($fp)	# spill _tmp695 from $t2 to $fp-32
	# _tmp696 = *(_tmp695)
	  lw $t0, -32($fp)	# fill _tmp695 to $t0 from $fp-32
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -36($fp)	# spill _tmp696 from $t2 to $fp-36
	# ACall _tmp696
	  lw $t0, -36($fp)	# fill _tmp696 to $t0 from $fp-36
	  jalr $t0            	# jump to function
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# PushParam house
	...
	# _tmp697 = *(house)
	  lw $t0, -12($fp)	# fill house to $t0 from $fp-12
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -40($fp)	# spill _tmp697 from $t2 to $fp-40
	# _tmp698 = *(_tmp697 + 4)
	  lw $t0, -40($fp)	# fill _tmp697 to $t0 from $fp-40
	  lw $t2, 4($t0) 	# load with offset
	  sw $t2, -44($fp)	# spill _tmp698 from $t2 to $fp-44
	# ACall _tmp698
	  lw $t0, -44($fp)	# fill _tmp698 to $t0 from $fp-44
	  jalr $t0            	# jump to function
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
  _L161:
	...
	# _tmp699 = *(house)
	  lw $t0, -12($fp)	# fill house to $t0 from $fp-12
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -48($fp)	# spill _tmp699 from $t2 to $fp-48
	# _tmp700 = *(_tmp699 + 24)
	  lw $t0, -48($fp)	# fill _tmp699 to $t0 from $fp-48
	  lw $t2, 24($t0) 	# load with offset
	  sw $t2, -52($fp)	# spill _tmp700 from $t2 to $fp-52
	# ACall _tmp700
	  lw $t0, -52($fp)	# fill _tmp700 to $t0 from $fp-52
	  jalr $t0            	# jump to function
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# _tmp701 = "\nDo you want to play another hand?"
	  ...
	  sw $t2, -56($fp)	# spill _tmp701 from $t2 to $fp-56
	# PushParam _tmp701
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -56($fp)	# fill _tmp701 to $t0 from $fp-56
	  sw $t0, 4($sp)	# copy param value to stack
	# _tmp702 = LCall _GetYesOrNo
	  jal _GetYesOrNo    	# jump to function
	  move $t2, $v0		# copy function return value from $v0
	  sw $t2, -60($fp)	# spill _tmp702 from $t2 to $fp-60
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# keepPlaying = _tmp702
	  lw $t2, -60($fp)	# fill _tmp702 to $t2 from $fp-60
	  sw $t2, -8($fp)	# spill keepPlaying from $t2 to $fp-8
	# Goto _L161
  ...
  _L162:
	...
	# _tmp703 = *(house)
	  lw $t0, -12($fp)	# fill house to $t0 from $fp-12
	  lw $t2, 0($t0) 	# load with offset
	  sw $t2, -64($fp)	# spill _tmp703 from $t2 to $fp-64
	# _tmp704 = *(_tmp703 + 20)
	  lw $t0, -64($fp)	# fill _tmp703 to $t0 from $fp-64
	  lw $t2, 20($t0) 	# load with offset
	  sw $t2, -68($fp)	# spill _tmp704 from $t2 to $fp-68
	# ACall _tmp704
	  lw $t0, -68($fp)	# fill _tmp704 to $t0 from $fp-68
	  jalr $t0            	# jump to function
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# _tmp705 = "Thank you for playing...come again soon.\n"
	  .data			# create string constant marked with label
	  _string69: .asciiz "Thank you for playing...come again soon.\n"
	  .text
	  la $t2, _string69	# load label
	  sw $t2, -72($fp)	# spill _tmp705 from $t2 to $fp-72
	# PushParam _tmp705
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -72($fp)	# fill _tmp705 to $t0 from $fp-72
	  sw $t0, 4($sp)	# copy param value to stack
	# LCall _PrintString
	  jal _PrintString   	# jump to function
	# PopParams 4
	...
	# _tmp706 = "\nCS143 BlackJack Copyright (c) 1999 by Peter Mor..."
	  ...
	  sw $t2, -76($fp)	# spill _tmp706 from $t2 to $fp-76
	# PushParam _tmp706
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -76($fp)	# fill _tmp706 to $t0 from $fp-76
	  sw $t0, 4($sp)	# copy param value to stack
	# LCall _PrintString
	  jal _PrintString   	# jump to function
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# _tmp707 = "(2001 mods by jdz)\n"
	  .data			# create string constant marked with label
	  _string71: .asciiz "(2001 mods by jdz)\n"
	  .text
	  la $t2, _string71	# load label
	  sw $t2, -80($fp)	# spill _tmp707 from $t2 to $fp-80
	# PushParam _tmp707
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -80($fp)	# fill _tmp707 to $t0 from $fp-80
	  sw $t0, 4($sp)	# copy param value to stack
	# LCall _PrintString
	  jal _PrintString   	# jump to function
	# PopParams 4
  ...
  _ReadLine:
          ...
          li $v0, 9
          syscall
          addu $a0, $v0, $zero  # copy allocated memory reference to $a0
          li $a1, 101           # read 100 + null terminator
